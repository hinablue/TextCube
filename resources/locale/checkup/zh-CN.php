...
$__text['Memcached 캐시를 초기화합니다.'] = 'Memcached 缓存初始化。';
$__text['SessionVisits 테이블의 블로그 정보 필드 이름을 변경합니다.'] = '依照 SessionVisits 数据表更新博客信息。';
$__text['fancyURL이 적용되지 않는 공지 글에 슬로건을 추가합니다.'] = '在不使用fancyURL 时，追加标题模式博客位址。';
...
$__text['완료되었습니다.'] = '已完成。';
$__text['원격 댓글 지원 기능을 위해 트랙백 테이블의 이름을 변경합니다.'] = '修改回覆资料表，支援远端评论与回覆。';
...
$__text['트랙백 테이블에 컨텐츠 종류를 판단하기 위한 필드를 추가합니다.'] = '更新回覆资料表中远端回覆的类别设定。';
$__text['트랙백 테이블의 호환성을 위하여 필드 이름을 변경합니다.'] = '修正回覆资料表中远端回覆的类别设定。';
$__text['페이지 캐시를 초기화합니다.'] = '重设页面缓存。';
$__text['필터 테이블에 예외 목록을 추가하기 위하여 필드 속성을 변경합니다.'] = '变更过滤器数据表，追加空白网址例外清单设定。';
$__text['필터 호환성을 위하여 필드의 이름을 변경합니다.'] = '修正过滤资料表栏位资料。';
