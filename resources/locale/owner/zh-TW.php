...
$__text['아래의 설정을 저장하셔도 반영되지 않습니다.'] = '你所儲存的設定沒有回應。';
$__text['기본 설정'] = '基本設定';
$__text['세션 타임아웃'] = 'Session 存活時間';
$__text['세션 타임 아웃까지의 시간을 설정합니다. 단위는 초입니다.'] = '設定 Session 的存活時間，單位為: 秒。';
$__text['기본 스킨'] = '預設樣板';
$__text['블로그의 기본 스킨을 정합니다. 반드시 존재하는 스킨의 디렉토리 이름이어야 합니다.'] = '設定部落格中的基本樣板，此名稱一定要存在於樣板清單中。若不存在，則使用預設(coolant)。';
...
$__text['이올린에 발행된 글만을 RSS 및 ATOM 피드로 내보냅니다.'] = '在 RSS 與 ATOM 上僅公開 "發行" 的文章。';
...
$__text['댓글 페이징을 사용하면 댓글은 기본적으로 닫힌 채로 출력됩니다.'] = '當引用或回覆完全展開後，再次點擊將會關閉引用或回覆的內容。';
...
$__text['&copy; 2004 - 2010. <br />텍스트큐브는 니들웍스/TNF에서 개발합니다.<br />텍스트큐브와 텍스트큐브 로고는 니들웍스의 상표입니다.'] = '&copy; 2004 - 2010. <br />版權所有屬於所有開發者與貢獻者。<br />TextCube 圖示與文字屬於 Needlworks 所有。';
$__text['개발자'] = '開發者';
$__text['Maintainer'] = '';
...
$__text['비공개로 변경합니다'] = '修改為不公開';
$__text['분류없음'] = '無分類';
$__text['환영합니다. <em>%1</em>님.'] = '歡迎光臨！<em>%1</em>。';
...
$__text['Line 추가에 실패했습니다.'] = '短消息新增失敗。';
