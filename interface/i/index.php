...
?>	
	...
	<?php
		...
		print $itemsView;
	?>
		<li><a href="<?php echo $blogURL;?>/entry" class="link"><?php echo _t('글목록');?></a></li>
		<li><a href="#categories" class="link"><?php echo _t('분류');?></a></li>
		<li><a href="#archives" class="link"><?php echo _t('보관목록');?></a></li>
		<li><a href="#tags" class="link"><?php echo _t('태그');?></a></li>
		<li><a href="<?php echo $blogURL;?>/comment" class="link"><?php echo _t('최근 댓글');?></a></li>
		<li><a href="<?php echo $blogURL;?>/trackback" class="link"><?php echo _t('최근 트랙백');?></a></li>
		<li><a href="<?php echo $blogURL;?>/guestbook" class="link"><?php echo _t('방명록');?></a></li>
		<li><a href="<?php echo $blogURL;?>/link" class="link"><?php echo _t('링크');?></a></li>
	<?php
		if (doesHaveOwnership()) {
	?>
		<li><a href="<?php echo $defaultURL;?>/owner/center/dashboard" onclick="window.location.href='<?php echo $defaultURL;?>/owner/center/dashboard'" class="link dashboard"><?php echo _t('관리 패널');?></a></li>
		<li><a href="<?php echo $blogURL;?>/logout" class="link logout"><?php echo _t('로그아웃');?></a></li>
	<?php
		}else{
	?>
		<li><a href="<?php echo $blogURL;?>/login" class="link"><?php echo _t('로그인');?></a></li>
	<?php
		}
	?>
    ...
    <form id="searchForm" method="GET" class="dialog snug editorBar" action="<?php echo $blogURL;?>/search">
        <fieldset>
            <h1><?php echo _t('글 검색');?></h1>
            <a class="button leftButton" type="cancel" onclick="searchAction(false);"><?php echo _t('취소');?></a>
            <a class="button blueButton" type="submit"><?php echo _t('검색');?></a>
