...
?>
<div id="comment_<?php echo $entry['id']."_".time();?>" title="<?php echo _t('댓글');?> : <?php echo htmlspecialchars($entry['title']);?>" selected="false">
<?php
...
?>
<div id="comment_<?php echo time();?>" title="<?php echo _t('최근 댓글');?>" selected="false">
<?php
