...
?>
<div id="trackback_<?php echo $entry['id']."_".time();?>" title="<?php echo _t('트랙백');?> : <?php echo htmlspecialchars($entry['title']);?>" selected="false">
<?php
...
?>	
<div id="trackback_<?php echo "_".time();?>" title="<?php echo _t('최근 트랙백');?>" selected="false">
<?php
