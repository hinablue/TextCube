...
?>
	...
	if ($jumpToTrackback) {
?>
		<li><a href="<?php echo $blogURL;?>/trackback/<?php echo $entry['id'];?>" accesskey="5"><?php echo _t('걸린 글 보기');?> (<?php echo $entry['trackbacks'];?>)</a></li>
		<?php
	}
