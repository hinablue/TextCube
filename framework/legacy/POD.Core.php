...
//		if(!$this->_validateInstance($instance)) return $this->_false();
	...
	function queryWithDBCache($query, $prefix = null, $type = MYSQLI_BOTH, $count = -1) {
//		requireComponent('Needlworks.Cache.PageCache');
	...
	function queryAllWithDBCache($query, $prefix = null, $type = MYSQLI_BOTH, $count = -1) {
//		requireComponent('Needlworks.Cache.PageCache');
		$cache = new queryCache($query, $prefix);
		if(!$cache->load()) {
	...
	function queryRowWithDBCache($query, $prefix = null, $type = MYSQLI_BOTH, $count = -1) {
//		requireComponent('Needlworks.Cache.PageCache');
		$cache = new queryCache($query, $prefix);
		if(!$cache->load()) {
	...
	function queryColumnWithDBCache($query, $prefix = null, $type = MYSQLI_BOTH, $count = -1) {
//		requireComponent('Needlworks.Cache.PageCache');
		$cache = new queryCache($query, $prefix);
		if(!$cache->load()) {
